...
import { StyleSheet, Text, View, Image, TouchableOpacity, ImageStore } from 'react-native';
...
export default function App({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      <View style={{ flex: 2 }}>
        <Image 
          source={{uri: 'https://i0.wp.com/bersamawisata.com/wp-content/uploads/2021/07/488600_18071812270066954646.jpg?fit=1024%2C768&ssl=1'}}
          style={{
            width: 400, 
            height: 300
            }} 
        ...
        <View style={{ flexDirection: 'row', marginTop: SIZES.base, paddingHorizontal: SIZES.padding * 2, justifyContent: 'space-between' }}>
                ...
                <View style={{ marginTop: SIZES.padding, paddingHorizontal: SIZES.padding }}>
                    ...
                    <Text style={{ marginTop: SIZES.radius, color: COLORS.gray, ...FONTS.body3 }}>
                      Located on The Alameda off of Interstate I-880, The Hotel Rose Garden is located in The Heart of Silicon Valley.
                    </Text>
                </View>
      </View>
